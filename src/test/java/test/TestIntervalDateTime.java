...
public final class TestIntervalDateTime {
	...
	public static void main(String[] args) throws Exception {
		...
		Test t1 = new Test(s -> {
			try {
				return Interval.from(s, DateTimeType.VALUE_CONSTRUCTOR).toString();
			} catch (Exception e) { return e.getMessage(); }
		});
		
		Test t2 = new Test( (s1,s2) -> {
			try {
				return Interval.from(s2, DateTimeType.VALUE_CONSTRUCTOR).contains(DateTimeType.valueOf(s1))+"";
			} catch (Exception e) { return e.getMessage(); }
		});
		
		/* test valid cases */
		t1.ts1("S01", "1968-02-28T12:00:00+01:00", "1968-02-28T12:00:00+01:00");
		t1.ts1("S02", "1968-02-29T12:00:00.500+01:00", "1968-02-29T12:00:00.5+01:00");
		t1.ts1("S03", "[1968-02-28T12:00:00+01:00 ..1968-03-01T12:00:00+01:00]", "[1968-02-28T12:00:00+01:00..1968-03-01T12:00:00+01:00]");
		t1.ts1("S04", "(1968-02-28T12:00:00+01:00.. 1968-03-01T12:00:00+01:00)", "(1968-02-28T12:00:00+01:00..1968-03-01T12:00:00+01:00)");
		t1.ts1("S05", "[1968-02-28T12:00:00+01:00..*)", "[1968-02-28T12:00:00+01:00..*)");
		t1.ts1("S06", "(*..1968-02-28T12:00:00+01:00]", "(*..1968-02-28T12:00:00+01:00]");
		t1.ts1("S07", "[*..*]", "(*..*)");
