 ...
 */
public abstract class NodeType extends Node implements ComponentType {

	private String globaltype = null; // the global type this component refers to, if it is a reference.
