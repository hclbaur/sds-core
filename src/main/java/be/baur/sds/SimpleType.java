 ...
 */
public abstract class SimpleType extends NodeType { 
	
	// legacy, will remove this whole thing later
...
//		
//		if (getPattern() != null)
//			node.getNodes().add(new Node(Attribute.PATTERN.tag, getPatternExpr()));
//		
//		if (stringType == ! isNullable())
//			node.getNodes().add(new Node(Attribute.NULLABLE.tag, String.valueOf(isNullable())));
//		
//		return node;
//	}
