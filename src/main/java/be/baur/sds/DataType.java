...
public final class DataType {
	...
	/**
	 * Function to construct an SDS binary value from a string. When applied, this
	 * function throws an {@code IllegalArgumentException} if the string is not in
	 * valid Base64 scheme.
	 */
	...
	/**
	 * Function to construct an SDS integer value from a string. When applied, this
	...
	/**
	 * Function to construct an SDS decimal value from a string. When applied, this
	 * function throws a {@code NumberFormatException} if the string cannot be
	...
	/**
	 * Function to construct an SDS date value from a string. When applied, this
	 * function throws a {@code DateTimeParseException} if the string cannot be
	 * converted to a date.
	 */
	...
	/**
	 * Function to construct an SDS datetime value from a string. When applied, this
	 * function throws a {@code DateTimeParseException} if the string cannot be
	...
	/**
	 * Function to construct an SDS boolean value from a string. When applied, this
	 * function throws an {@code IllegalArgumentException} if the string equals
